...
def build_baseline_model(n_classes, embedding_dim=50, embedding_matrix=None, latent_dim=128, dropout=0.0, merge_mode='concat'):
    """Build the baseline model, consisting in a BiLSTM plus a Dense layer on top.
